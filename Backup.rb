...
bot.command :ping do |event|
  event.respond "#{(event.timestamp - Time.now ).round}s" # Tempo de resposta com aproximacao de Inteiro mais proximo
end
...
bot.command(:play) do |event, songlink|
  ...
  unless channel.nil?
    ...
    YoutubeDL.download (songlink), output: 'C:/Users/Pulhote/Desktop/Thanatos/Songs/Audio.mp3'
...
bot.command :netflix do |event|
  ...
  netflix_image = event.send_file(File.open("C:/Users/Pulhote/Desktop/Thanatos/netflixlogo.png", 'r'))
